        ...
        <div className="bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="flex gap-3 md:gap-10 flex-col md:flex-row justify-end items-start md:items-center space-y-4 lg:space-y-0">
                ...
                {contactInfo?.ctaLabel && (
                  <button 
                    className="bg-blue-900 text-white px-6 py-2 rounded-[48px] m-0 hover:bg-blue-800 transition-colors duration-200 text-sm font-medium"
