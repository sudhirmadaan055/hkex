...
const Q1Results = async () => {
  ...
  return (
    ...
    >
      ...
      <div className="container w-full mx-auto px-8 relative z-10 d-flex gap-4 flex-col xl:flex-row xl:gap-0 justify-between">
        {/* Left Section - Text Content */}
        <div className="text-white pr-8 max-w-full w-full xl:max-w-[738px]">
