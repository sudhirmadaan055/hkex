            ...
            <div className="container py-5">
              <div className="row justify-content-center">
                <div className="col-lg-8 text-center">
                  ...
                  <h2 className="display-4 fw-bold text-dark mb-3">No Teams Available</h2>
                  <p className="lead text-muted">
                    We're currently setting up our amazing teams. Check back soon to meet our talented members!
                  </p>
                </div>
              </div>
            </div>
